...
def get_stride_len(matrices, time_stamps):
    ...
    second_step = []
    # iterate through j to top of matrix to find second non zero element
    flag = 0
    ...
    # print(second_step[0][0], second_step[0][1], second_step[0][2])
    # time difference between first and second step in seconds
